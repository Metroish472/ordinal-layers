const game = {
    ...
    achievements: [
        ...
        new Achievement("I wonder what new operators are like", "Start gaining operators", "&aleph;", () => game.alephLayer.isUnlocked()),
        new Achievement("Ordinal Level 1 Operators", "Have 1e10 operators", "&aleph;<sub>1</sub>", () => game.alephLayer.aleph.gte("1e10")),
        new Achievement("Googological Operators", "Have 1e100 operators", "&aleph;<sub>2</sub>", () => game.alephLayer.aleph.gte("1e100")),
        new Achievement("Hyperoperators", "Have 1.8e308 operators", "&aleph;<sub>3</sub>", () => game.alephLayer.aleph.gte("1.8e308")),
        ...
        new Achievement("Idle^2", "Buy the ordinalized upgrade", "↑<sub>2<sub>", () => game.restackLayer.metaUpgrade.level.gte(1)),
    ...
    secretAchievements: [
        ...
        new Achievement("Operation Ordinal", "Have 1e1000 aleph", "&aleph;<sub>π</sub>", () => game.alephLayer.aleph.gte("1e1000")),
    ...
    alephLayer: new OperatorsLayer(),
    restackLayer: new ReStackLayer(),
    metaLayer: new OrdinalizeLayer(),
    currentLayer: null,
