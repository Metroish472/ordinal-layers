...
<div class="resource">
    <p>You have {{formatNumber(aleph.aleph, 2, 2, 1e9)}} <span class="aleph">operators</span></p>
    <p>You get {{formatNumber(aleph.getAlephGain(), 2, 2, 1e9)}} <span class="aleph">operators</span> every second</p>
</div>
<div class="boosts">
    <div v-if="canProduceAleph">
        <p>Your Ordinal Level is <resource-name :layerid="highestLayer()"></resource-name>, translated to a x{{formatNumber(aleph.getAlephBoostFromLayer(), 2, 2)}} Boost on <span class="aleph">operator</span> gain</p>
    </div>
    <div v-else>
